...
namespace Pysar.Wpf.Sample.ViewModels;
...
/// <summary>
///     Drives the report picker and the viewer's toolbar. Ported from the Avalonia sample's view model
...
public sealed partial class ReportViewerViewModel : ObservableObject
{
    ...
    {
        _printer = printer ?? new WpfReportPrinter(PysarWpf.Renderer);
        LoadReport();
    }
